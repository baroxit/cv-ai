        ...
        <nav className={`sticky top-0 z-40 border-b transition duration-200 ease-in-out animate-header-slide-down-fade ${scrolled ? 'border-white/20' : 'border-transparent'}`}>
            <div className="flex px-4 justify-between h-[58px] items-center mx-auto w-full max-w-screen-lg backdrop-blur-md">
                <div className="flex items-center">
                    ...
                    <span className="text-lg font-semibold tracking-wide">promptCv</span>
                </div>
                    ...
                    {user ? (
                        <>
                            ...
                            <Link href="/dashboard/experiences">
                                <Button variant="default" className="rounded-full text-sm font-semibold px-4 py-2">Dashboard</Button>
                            </Link>
                        </>
                    ) : (
                        <>
                            <Link href="/login">
                                <Button variant="outline" className="rounded-full text-sm font-semibold px-4 py-2">Login</Button>
                            </Link>
                            <Link href="/auth/signup">
                                <Button variant="default" className="rounded-full text-sm font-semibold px-4 py-2">Sign Up</Button>
                            </Link>
                        </>
                    )}
                </div>
