...
const HeroSection: React.FC<HeroSectionProps> = ({ className }) => {
	return (
		<div className={cn('container', className)}>
			...
			<div className='my-4 font-display effect-font-styling text-[3.5rem] md:text-6xl leading-[4.35rem] md:leading-[5rem] tracking-tight gradient-text hero-text text-center md:text-left'>
				Tailor your CV for every opportunity
			</div>
			<div className='md:w-3/3'>
				<div className='text-lg md:text-xl text-center md:text-left tracking-tight leading-tight mt-1 text-balance'>
			...
			<Link href='/auth/signup'>
				<Button className='max-md:mx-auto group mt-8 flex justify-between rounded-full text-[15px] font-semibold py-5 pr-2 pl-4 w-56'>
